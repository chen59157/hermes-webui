...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_assistant_title: 'Assistant Settings',
    settings_section_assistant_meta: 'Manage multi-platform integration channels.',
    thinking_panel_status_waiting: 'Waiting...',
    thinking_panel_status_thinking: 'Thinking...',
    thinking_panel_status_done: 'Done',
    thinking_panel_placeholder: 'AI thinking process will be displayed here...',
    ...
    provider_quota_active_title: 'Active provider quota',
    provider_quota_unavailable_fallback: 'Quota status unavailable',
    provider_quota_state_available: 'Available',
    provider_quota_state_unavailable: 'Unavailable',
    provider_quota_state_unsupported: 'Unsupported',
    provider_quota_state_no_key: 'No key',
    provider_quota_state_invalid_key: 'Invalid key',
    settings_section_plugins_title: 'Plugins',
    settings_section_plugins_meta: 'View installed Hermes plugins and the lifecycle hooks they register. This panel is read-only.',
    plugins_empty: 'No Hermes plugins are currently visible. Install or enable plugins from the Hermes CLI/config to see them here.',
  ...
  zh: {
    ...
    session_jump_start_label: '跳转到会话开始',
    session_jump_end: '结束',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    provider_quota_active_title: '当前大模型供应商配额',
    provider_quota_unavailable_fallback: '配额状态不可用',
    provider_quota_state_available: '可用',
    provider_quota_state_unavailable: '不可用',
    provider_quota_state_unsupported: '不支持',
    provider_quota_state_no_key: '无 key',
    provider_quota_state_invalid_key: 'key 无效',
    settings_section_plugins_title: '插件',
    settings_section_plugins_meta: '查看已安装的 Hermes 插件及其注册的生命周期钩子。此面板为只读。',
    plugins_empty: '当前未看到任何 Hermes 插件。可在 Hermes CLI 或 config 中安装/启用插件后查看。',
    plugins_load_failed: '加载插件失败：',
    plugins_no_hooks: '未注册任何生命周期钩子',
    plugins_no_description: '暂无描述。',
    ...
    settings_section_assistant_title: '助理设置',
    settings_section_assistant_meta: '管理多平台集成通道，将 Hermes 连接到微信、飞书、钉钉等平台。',
    thinking_panel_status_waiting: '等待中...',
    thinking_panel_status_thinking: '思考中...',
    thinking_panel_status_done: '完成',
    thinking_panel_placeholder: '发送消息后，AI 的思考过程将在此实时展示...',
    ...
    // Insights range labels (missing in zh)
    ...
    system_health_sub: '当前 VPS 资源用量',
    system_health_loading: '加载中…',
    system_health_status_partial: '部分可用',
    system_health_status_live: '正常',
    system_health_status_unavailable: '不可用',
    system_health_foot: '仅实时快照；历史资源图表可在此基础上构建。',

    // LLM Wiki panel
    llm_wiki_title: 'LLM 知识库',
    llm_wiki_sub: '知识库可观测性',
    llm_wiki_badge_available: '可用',
    llm_wiki_badge_error: '错误',
    llm_wiki_badge_empty: '空',
    llm_wiki_badge_unavailable: '不可用',
    llm_wiki_status_ready: 'LLM Wiki 已配置，页面元数据可见（不暴露 Wiki 内容）。',
    llm_wiki_status_empty: 'LLM Wiki 已存在但尚无 entity、concept、comparison 或 query 页面。',
    llm_wiki_status_error: '无法检查 LLM Wiki 状态',
    llm_wiki_status_missing: '未找到 LLM Wiki 目录。设置 WIKI_PATH 或 skills.config.wiki.path 以启用状态可见性。',
    llm_wiki_field_enabled: '已启用',
    llm_wiki_field_entries: '条目数',
    llm_wiki_field_pages: '页面数',
    llm_wiki_field_raw_files: '原始文件',
    llm_wiki_field_last_updated: '最后更新',
    llm_wiki_field_last_writer: '最后编辑者',
    llm_wiki_value_yes: '是',
    llm_wiki_value_no: '否',
    llm_wiki_value_not_available: '不可用',
    llm_wiki_toggle_available: '可通过 Hermes Agent 配置切换。',
    llm_wiki_toggle_unavailable: '未检测到稳定的 LLM Wiki 开关配置，此面板为只读。',
